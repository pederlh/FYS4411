...
private:
    void (BoltzPar::*optimizer)();
    void (BoltzPar::*MetropolisMethod)();
...
public:
    ...
    int interaction_, it_num, its, thread_ID_;

    mat r_old_, r_new_, quantum_force_, quantum_force_old_,quantum_force_new_;

    vec DeltaE_;

    BoltzPar(int num_particles,int dimentions, double eta, int MC, int type_sampling, int interaction, double omega, int thread_ID);
